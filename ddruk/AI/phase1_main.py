...
if __name__ == "__main__":
    ...
    all_reviews_file_path = f'./datas/api_result_reviews_relv_{APP_NAME}_v0.json'
    ...
    appmeta_path = f'./datas/standard_app_description_{APP_NAME}_v0.json'
    ...
    start_index=0 # 0
    end_index=100 # Number of reviews (But testing e 10 dbo)
    chunk_mode=False # Is the data chunked
    p_flag=False # Are we processing the postive reviews
    price_flag=True # Are we processing the price
    ...
    with open(f'./datas/phase1_result_{APP_NAME}_v0_0_100.json', 'w') as json_file:
