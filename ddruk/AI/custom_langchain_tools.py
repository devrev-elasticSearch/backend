...
#   print(f"3 >> {os.getenv('OPENAI_ORG')}")
  ...
  Now, summarize all of the app RELATED TECHNICAL features in less than 150 words. DO NOT write any non-technical features.:
  Answer: Let's write point by point.
  Invoke a relevant tool when you need to store these app TECHNICAL features.
  """
